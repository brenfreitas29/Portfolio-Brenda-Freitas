...
export default function HairSkinClinicProjectPage() {
  return (
    <main className="min-h-screen bg-[#24194f] text-white">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            <ScrollReveal>
              <div>
                ...
                <h1 className="text-5xl font-medium leading-[0.95] tracking-[-0.055em] md:text-7xl lg:text-8xl">
                  Hair & Skin Clinic
                </h1>

                <p className="mt-8 max-w-xl text-lg leading-8 text-[#ddd5f3]/75">
                  A premium multilingual digital experience designed for a
                  modern hair and skin clinic, combining clear navigation,
                  visual trust and conversion-focused patient journeys.
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="mt-20 rounded-[2rem] border border-white/15 bg-[#281d61]/60 p-4 shadow-[0_40px_120px_rgba(20,10,60,0.35)] backdrop-blur-xl md:p-7">
              <div className="overflow-hidden rounded-[1.4rem] border border-white/10 bg-[#21174b]">
                ...
                <div className="relative aspect-[16/9] overflow-hidden bg-[#f5f6fa]">
                  <Image
                    src="/projects/hair-skin-clinic.png"
                    alt="Hair & Skin Clinic website"
                    fill
                    priority
          ...
          <div>
            <ScrollReveal>
              <h2 className="max-w-4xl text-4xl font-medium leading-[1.08] tracking-[-0.04em] md:text-6xl">
                A digital experience built around{" "}
            ...
            <div className="mt-10 grid gap-8 md:grid-cols-2">
              <ScrollReveal delay={0.1}>
                <p className="text-base leading-7 text-[#ddd5f3]/70">
                  The website presents treatments, clinic information and key
                  actions in a clean structure designed to make the patient
              ...
              <ScrollReveal delay={0.2}>
                <p className="text-base leading-7 text-[#ddd5f3]/70">
                  The visual system balances a premium medical aesthetic with
                  accessibility, responsive behavior and multilingual support.
                </p>
              </ScrollReveal>
            </div>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <ScrollReveal y={45}>
              ...
              >
                ...
                <h3 className="mt-6 text-3xl font-medium tracking-[-0.035em] md:text-4xl">
                  Medical websites need to feel informative without becoming
                  overwhelming.
                </h3>

                <p className="mt-6 leading-7 text-[#ddd5f3]/70">
                  Patients need to understand services quickly, find relevant
                  information and know exactly how to take the next step.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.14} y={45}>
              ...
              >
                ...
                <h3 className="mt-6 text-3xl font-medium tracking-[-0.035em] md:text-4xl">
                  A structured, responsive experience with clear calls to
                  action.
                </h3>

                <p className="mt-6 leading-7 text-[#eee6fa]/75">
                  The interface combines strong visual hierarchy,
                  multilingual navigation and focused conversion points while
                  maintaining a premium clinical identity.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal>
            <div className="mb-12">
              ...
              <h2 className="mt-5 max-w-3xl text-4xl font-medium tracking-[-0.04em] md:text-6xl">
                Information designed to remain clear at every step.
              </h2>
            </div>
          </ScrollReveal>

          <ScrollReveal delay={0.1} y={65}>
            <div className="rounded-[2rem] border border-white/15 bg-[#281d61]/60 p-4 shadow-[0_35px_110px_rgba(20,10,60,0.35)] md:p-7">
              <div className="overflow-hidden rounded-[1.4rem] border border-white/10 bg-[#21174b]">
                ...
                <div className="relative aspect-[16/9] overflow-hidden bg-[#f5f6fa]">
                  <Image
                    src="/projects/hair-skin-detail.jpg"
                    alt="Hair & Skin Clinic detail page"
                    fill
                    className="object-contain object-center"
                    sizes="(max-width: 768px) 100vw, 1200px"
                  />
        ...
        <div className="mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-36">
          ...
          <ScrollReveal delay={0.08}>
            <h2 className="max-w-3xl text-4xl font-medium tracking-[-0.04em] md:text-6xl">
              Designed for a modern healthcare experience.
            </h2>
          </ScrollReveal>
      ...
      <section className="border-t border-white/10 bg-gradient-to-b from-[#2e216b] to-[#291d5d]">
        <div className="mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-36">
          <ScrollReveal>
            <p className="mb-6 text-xs uppercase tracking-[0.35em] text-[#d7cdf2]/60">
              Technology
          ...
          <ScrollReveal delay={0.08}>
            <h2 className="max-w-3xl text-4xl font-medium tracking-[-0.04em] md:text-6xl">
              Built for responsive, multilingual experiences.
            </h2>
          </ScrollReveal>
