            ...
            <Magnetic strength={0.3}>
              <a
                ...
                className="
                  ...
                  font-medium
                  text-[#2d2168]
                  shadow-[0_15px_50px_rgba(210,170,255,0.15)]
                  transition
                  duration-300
                  hover:scale-105
                  hover:bg-[#f5d6ef]
                  hover:shadow-[0_20px_60px_rgba(230,160,220,0.25)]
                "
              >
                Get in touch
        ...
        <div className="mx-auto max-w-7xl px-6 py-10 md:px-10">
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            ...
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-x-7 gap-y-4">
                ...
                >
                  ...
                  <span className="text-[#e8b9e5]/60 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">
                    ↗
                  </span>
                </a>
            ...
            <div className="flex flex-col gap-5 md:items-end">
              ...
              <p className="text-xs text-[#d6cced]/35">
                © 2026 Brenda Studio
              </p>
            </div>
          </div>
