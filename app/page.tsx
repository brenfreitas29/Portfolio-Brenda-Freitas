...
const projects = [
...

  {
    ...
    image: "https://vivatrip.vercel.app/og.png",
...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden text-white">
      ...
      <section
        id="work"
        className="relative overflow-hidden border-t border-white/10 bg-gradient-to-b from-[#5748b9] via-[#3c2f86] to-[#291f62] px-6 py-28 md:px-10 md:py-36"
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="mb-20 md:mb-28">
            <p className="mb-5 text-xs uppercase tracking-[0.38em] text-[#d4c9f1]/70">
              Selected Work
            </p>

            <h2 className="max-w-4xl text-4xl font-medium tracking-[-0.045em] md:text-6xl lg:text-7xl">
              Digital products built
              <span className="block bg-gradient-to-r from-[#f3acd9] via-[#d8b4ff] to-[#aaa0ff] bg-clip-text text-transparent">
                to feel different.
              </span>
            </h2>
          </div>
      ...
      <section
        id="contact"
        className="relative overflow-hidden border-t border-white/10 bg-gradient-to-b from-[#362776] via-[#2e216b] to-[#24194f]"
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 text-center md:px-10 md:py-48">
          <p className="mb-7 text-xs uppercase tracking-[0.35em] text-[#d7cdf2]/65">
            Let&apos;s work together
          </p>
          ...
          <p className="mx-auto mt-8 max-w-xl text-base leading-7 text-[#ddd5f3]/70">
            Open to Full Stack, Frontend and product-focused engineering opportunities, as well as selected freelance projects.
          </p>
          ...
          <div className="mt-10 flex justify-center">
            <Magnetic strength={0.3}>
              <a
                ...
                className="group inline-flex items-center gap-3 rounded-full bg-white px-7 py-4 text-sm font-medium text-[#2d2168] shadow-[0_15px_50px_rgba(210,170,255,0.15)] transition duration-300 hover:scale-105 hover:bg-[#f5d6ef] hover:shadow-[0_20px_60px_rgba(230,160,220,0.25)]"
              >
                Get in touch
          ...
          <p className="mt-7 text-[10px] uppercase tracking-[0.24em] text-white/35">
            Open to remote roles · Argentina / LATAM · Freelance
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-x-7 gap-y-4">
                <a
                  href="https://github.com/brenfreitas29"
                  target="_blank"
                ...
                >
                  GitHub
                  <span className="text-[#e8b9e5]/60 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">↗</span>
                </a>

                <a
                  href="https://www.fiverr.com/brendafreita29"
                  target="_blank"
                  rel="noopener noreferrer"
                  data-cursor="interactive"
                  className="group inline-flex items-center gap-2 text-sm text-white/65 transition-colors duration-300 hover:text-white"
                ...
                <a
                  href="https://www.upwork.com/freelancers/~01df086fbcd7634d5f"
                  target="_blank"
                  rel="noopener noreferrer"
                  data-cursor="interactive"
                  className="group inline-flex items-center gap-2 text-sm text-white/65 transition-colors duration-300 hover:text-white"
            ...
            <div className="flex flex-col gap-5 md:items-end">
              <nav className="flex flex-wrap gap-5 text-xs text-[#d6cced]/55">
                <a href="#work" data-cursor="interactive" className="transition-colors duration-300 hover:text-white">Work</a>
                <a href="#about" data-cursor="interactive" className="transition-colors duration-300 hover:text-white">About</a>
                <a href="#services" data-cursor="interactive" className="transition-colors duration-300 hover:text-white">Services</a>
                <a href="#contact" data-cursor="interactive" className="transition-colors duration-300 hover:text-white">Contact</a>
              </nav>
