...
const projects = [
  ...
  { number: "03", title: "VivaTrip", category: "TRAVEL APP", description: "A travel planning product with authentication, saved trips and pre-travel workflows.", tags: ["Next.js", "TypeScript", "Supabase", "PostgreSQL"], image: "/projects/vivatrip-preview-en.jpg", href: "/projects/vivatrip", liveUrl: "https://vivatrip.vercel.app", codeUrl: "https://github.com/brenfreitas29/VivaTrip" },
];
...
export default function Home() {
  return <main className="br-site">
    ...
    <section id="about" className="br-about br-container" aria-labelledby="about-title">
      <div className="br-about-top"><span>01 / ABOUT ME</span><span>CODE WITH PEOPLE IN MIND.</span></div>
      <div className="br-preview-row" aria-hidden="true"><div className="br-preview br-preview-one"><Image src="/projects/flowdesk-dashboard.jpg" alt="" fill sizes="25vw" className="object-cover"/></div><div className="br-preview br-preview-two"><Image src="/projects/hair-skin-clinic.png" alt="" fill sizes="25vw" className="object-cover"/></div><div className="br-preview br-preview-three"><Image src="/projects/vivatrip-preview-en.jpg" alt="" fill sizes="25vw" className="object-cover"/></div></div>
      <div className="br-about-text"><h2 id="about-title">ABOUT <span>ME</span></h2><p>I&apos;m Brenda, a junior full stack developer based in Buenos Aires. My background in customer support and operations taught me to listen closely to users. Today I turn those needs into responsive interfaces and connected web applications.</p><Link href="/resume" className="br-pill">VIEW RÉSUMÉ ↗</Link></div>
    </section>
